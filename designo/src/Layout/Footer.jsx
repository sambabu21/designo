...
export default function Footer(){
    return <div className="w-full bg-[#1D1C1E] h-[815px]  sm:h-[393px] py-32 relative flex justify-center">
        <div className="w-[90vw] lg:w-[75vw] lg:h-[292px] bg-[#E7816B] absolute bottom-[740px] sm:bottom-[340px] rounded-[15px] flex lg:flex-row flex-col sm:px-[90px] py-[70px] bg-img items-center">
        
            <div className="lg:w-1/2 sm:w-3/4 w-[85%]">
                <h1 className="text-[32px] sm:text-[40px] font-medium text-white leading-10 text-center">Let’s talk about your project</h1>
        ...
        <div className="w-[90vw] lg:w-[75vw] m-auto sm:h-[177px]">
            <div className="flex flex-col sm:flex-row sm:justify-between items-center h-[40%] border-b-[#97979741] border-b ">
            <div className="sm:h-1/2 ">
                ...
                >
                    ...
                    <h1 className='spartan font-bold text-[24px] tracking-[5px] text-white'>DESIGNO</h1>
                </Link>
                </div>
                <div className="flex gap-10 sm:h-1/2  items-center flex-col sm:flex-row my-10">
                    <NavLink
                        to="/company"
                        className='nav__link text-sm sm:text-md text-white font-normal leading-[14px] tracking-[2px]  mx-2 hover:underline'
                    >
                        OUR COMPANY 
                    </NavLink>
                    <NavLink
            ...
            <div className="sm:h-[60%] flex flex-col sm:flex-row justify-between sm:justify-center  items-center gap-5">
                <div className="sm:w-[350px]  mt-8">
                    <h3 className="font-bold text-[#ffffff94]">Designo Central Office</h3>
                    <p className="font-normal text-[#ffffff94]">3886 Wellington Street</p>
                    <p className="font-normal text-[#ffffff94]">Toronto, Ontario M9C 3J5</p>
                </div>
                <div className="sm:w-[350px]  mt-8 flex flex-col items-center sm:items-start">
                    <h3 className="font-bold text-[#ffffff94]">Contact Us (Central Office)</h3>
                    <p className="font-bold text-[#ffffff94]">P : +1 253-863-8967</p>
                    <p className="font-bold text-[#ffffff94]">M : contact@designo.co</p>
                </div>
                <div className="sm:w-[350px]  mt-8 flex gap-5  justify-end items-end">
